...
func TestOriginCloudRegionDelete(t *testing.T) {
	...
	_, err := client.Cache.OriginCloudRegions.Delete(
		context.TODO(),
		"192.0.2.1",
...
func TestOriginCloudRegionBulkDelete(t *testing.T) {
	...
	_, err := client.Cache.OriginCloudRegions.BulkDelete(context.TODO(), cache.OriginCloudRegionBulkDeleteParams{
		ZoneID: cloudflare.F("023e105f4ecef8ad9ca31a8372d0c353"),
	})
	if err != nil {
		var apierr *cloudflare.Error
...
func TestOriginCloudRegionGet(t *testing.T) {
	...
	_, err := client.Cache.OriginCloudRegions.Get(
		context.TODO(),
		"192.0.2.1",
...
func TestOriginCloudRegionSupportedRegions(t *testing.T) {
	...
	_, err := client.Cache.OriginCloudRegions.SupportedRegions(context.TODO(), cache.OriginCloudRegionSupportedRegionsParams{
		ZoneID: cloudflare.F("023e105f4ecef8ad9ca31a8372d0c353"),
	})
	if err != nil {
		var apierr *cloudflare.Error
